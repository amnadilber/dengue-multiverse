...
countries'' for consideration at \emph{Epidemics}.

Mechanistic models fitted to surveillance data are routinely used to test
...
The work is relevant to \emph{Epidemics} because it is a study of inference in
epidemic models rather than a forecasting paper: the object of study is the
estimator and the decision rule, not the epidemic. The main text is accompanied
by a supplement holding the factor-list robustness analysis, the criterion
comparison, further checks and a worked identifiability case study.
